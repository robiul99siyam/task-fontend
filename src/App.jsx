  ...
  return (
    <>
      <div
        ...
        className="relative w-full h-auto min-h-screen md:h-[100vh] lg:h-[100vh] bg-cover bg-center bg-radial bg-[radial-gradient(at_15%_75%,_#3c9dca,_#0054BF,_#4f46e5)] overflow-hidden"
      >
